...
for i = 1, 3, 1 do
  ...
  if i==1 then
    ...
    corpus_file_num = processed_file_name
    -- processed_txt= io.open(thre_processed_file_name, 'w')
    corpus_file = processed_file_t7
  elseif i==2 then
    print("Processing file valid")
    corpus_file_num = processed_file_name_valid         
    -- processed_txt = io.open(thre_processed_file_name_valid, 'w')
    corpus_file = processed_file_t7_valid
  else
    print("Processing file test")
    corpus_file_num = processed_file_name_test
    -- processed_txt = io.open(thre_processed_file_name_test, 'w')
    corpus_file = processed_file_t7_test
  end
